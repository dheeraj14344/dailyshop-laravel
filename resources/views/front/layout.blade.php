            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                @if($totalCartItem>0)
                  ...
                  <a class="aa-cartbox-checkout aa-primary-btn" href="{{url('http://127.0.0.1:8000/cart')}}">Cart</a>
                @endif
                </div>
              </div>
              <!-- / cart box -->
              ...
              <div class="aa-search-box">
                <form action="">
                  ...
                  <button type="button" onclick="funSeach()">
      ...
      <div class="modal-content">                      
        ...
        <div id="popup_login">
          ...
          <form class="aa-login-form" id="frmLogin">
            ...
            <input type="email" name="str_login_email" placeholder="Email" required value="{{$login_email}}">
            <label for="">Password<span>*</span></label>
            <input type="password" name="str_login_password" placeholder="Password" value="{{$login_pwd}}">
