...
Route::group(['middleware'=>'admin_auth'], function(){
	...
	Route::get('admin/password', [AdminController::class,'updatepassword']);
	...
	Route::get('admin/update_order_status/{status_id}/{id}', [OrderController::class,'update_order_status']);
	...
	Route::get('admin/product/product_attr_delete/{pAttrid}/{id}', [ProductController::class,'product_attr_delete']);

	Route::get('admin/product/product_images_delete/{pImgAttrid}/{id}', [ProductController::class,'product_images_delete']);
